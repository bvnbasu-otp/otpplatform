...
export const LINEAR_PROCUREMENT_STEPS: Record<ProcurementStepNumber, LinearStepDescriptor> = {
  ...
  6: {
    ...
    shortLabel: '6. Compare Quotes',
    description: 'Side-by-side identity-protected evaluation matrix on cost, specs, and turnaround.',
    icon: '⚖️',
  ...
  12: {
    ...
    title: 'Reveal Winning Supplier',
    shortLabel: '12. Reveal Winner',
    description: 'Cryptographic identity reveal: unmasks winning supplier; keeps losing quotes anonymous.',
    icon: '🏆',
    badgeClass: 'bg-emerald-100 text-emerald-800 border-emerald-300 dark:bg-emerald-950 dark:text-emerald-300',

-- Migration 00047: Add create_purchase_order_from_award RPC function
-- Allows authorized buyers to create a Purchase Order from a revealed award without RLS violation on quotes.

/**
 * OTP Platform — Automated Test Suite Coverage & Policy Engine (CJS)
 */
const fs = require('fs');
...
function checkCoverageAppendRule(strict = false) {
  const violations = [];
...
function runPolicyAudit(strict = false) {
...
module.exports = { auditTestCategories, checkCoverageAppendRule, runPolicyAudit };

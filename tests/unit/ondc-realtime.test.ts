...
} from '../../packages/services/src/ondc/crypto/ondc-auth-crypto';
import { OndcBapReceiver } from '../../packages/services/src/ondc/receiver/ondc-bap-receiver';
import { mapCategoryToOndcDomain } from '../../packages/services/src/ondc/ondc-network-service';
import type { OndcCatalog, OndcPayload } from '../../packages/services/src/ondc/types/ondc-beckn';
...
describe('ONDC Beckn Real-time Cryptography & Protocol Suite', () => {
  ...
  it('parses incoming ONDC /on_select price breakup into OTP blind quote format', () => {
    const receiver = new OndcBapReceiver();

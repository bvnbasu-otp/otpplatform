...
export const MASTER_MODULE_INVENTORY: ModuleTestInventory[] = [
  ...
  },
  {
    ...
    description: 'Role-based PWA routing, Supplier Home Cockpit, Buyer Procurement Cockpit, Active RFQ Monitoring, RFQ Review & Publish, Supplier Discovery, committee voting, intake, quick-quote, and 8-state lifecycle',
    filesCount: 73,
    testCount: 616,
    category: 'WEB_UI',
...
const ALL_TEST_CASES: TestCase[] = [
  ...
  },
  {
    id: 'INT-009',
    category: 'INTEGRATION',
    name: 'Supplier Discovery & Radar Matching',
  ...
  },
  {
    id: 'INT-010',
    category: 'INTEGRATION',
    name: 'RFQ Review & Direct Publishing',
  ...
  },
  {
    id: 'INT-011',
    category: 'INTEGRATION',
    name: 'Active RFQ Monitoring & Quorum Management',
  ...
  },
  {
    id: 'INT-012',
    category: 'INTEGRATION',
    name: 'Supplier Home Mobile Cockpit & Opportunities',

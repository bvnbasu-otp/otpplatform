    ...
    <div className="zero-scroll-container p-3 max-w-7xl mx-auto w-full">
      ...
      <div className="rounded-lg border bg-card px-3 py-2 shadow-2xs shrink-0 flex items-center justify-between gap-2">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1 rounded-md bg-primary px-3 py-1 text-xs font-bold text-primary-foreground shadow-2xs hover:bg-primary/90 transition shrink-0"
        >
        ...
        <div className="zero-scroll-pane grid grid-cols-1 md:grid-cols-3 gap-3">
          <section className="rounded-lg border bg-card p-3 md:col-span-2 space-y-2">
            ...
            <dl className="grid grid-cols-2 gap-2 text-xs">
              ...
              <div className="col-span-2 bg-muted/10 p-2.5 rounded border">
            ...
            <div className="space-y-1.5 pt-2 border-t">
              {rfqId ? (
                <>
                  <Link
                    to={`/requirements/${requirementId}/discover`}
                    className="w-full flex items-center justify-between rounded-md bg-primary px-3 py-1.5 text-xs font-bold text-primary-foreground shadow-2xs hover:bg-primary/90 transition"
                  >

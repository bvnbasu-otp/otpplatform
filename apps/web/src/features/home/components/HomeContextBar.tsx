        ...
        <div className="flex items-center gap-2 shrink-0">
          {subscriptionExpired && onRenewClick && (
            <button
              ...
              className="min-h-[44px] inline-flex items-center gap-1 rounded-xl px-2.5 py-1.5 text-[11px] font-extrabold border bg-amber-100 dark:bg-amber-950 text-amber-900 dark:text-amber-300 border-amber-300 dark:border-amber-800 transition active:scale-95 mobile-touch-target cursor-pointer"
            >
          ...
          <button
            ...
            onClick={onRefresh}
            disabled={isLoading}
            className="min-h-[44px] min-w-[44px] rounded-xl border border-border/80 bg-card hover:bg-muted p-2 text-muted-foreground hover:text-foreground transition flex items-center justify-center active:scale-95 disabled:opacity-50 mobile-touch-target cursor-pointer"

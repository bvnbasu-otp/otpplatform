...
export function SupplierOpportunityCard({ opportunity }: SupplierOpportunityCardProps) {
  return (
    ...
    >
      {/* Top Meta Row: Public Ref, Anonymous Buyer Shield & Urgency Chip */}
      ...
      <div className="pt-0.5">
        <Link
          ...
          className="min-h-[48px] w-full flex items-center justify-center gap-1.5 rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2.5 text-xs font-extrabold shadow-sm active:scale-98 transition shadow-primary/20"
        >
